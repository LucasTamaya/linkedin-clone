      ...
      >
        ...
        >
          <div className={styles.news__top}>
            <h2 className={lightMode ? `${styles.news__top__h2}` : `${styles.news__top__h2} ${styles.dark}`}>Linkedin News</h2>
            <InfoIcon className={lightMode ? `${styles.news__top__icon}` : `${styles.news__top__icon} ${styles.dark}`}/>
          </div>
          <div className={styles.news__items}>
            <div className={styles.news__items__title}>
                <CircleIcon className={lightMode ? `${styles.news__items__title__icon}` : `${styles.news__items__title__icon} ${styles.dark}`}/>
                <p className={lightMode ? `${styles.news__items__title__para}` : `${styles.news__items__title__para} ${styles.dark}`}>Voila une superbe news !</p>
            </div>
